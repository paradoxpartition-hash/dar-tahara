...
const en: EarlyAccessCopy = {
  ...
  fields: {
    ...
    residenceCountry: "Country of residence", billingRecipientType: "This account is for",
...
const fr: EarlyAccessCopy = {
  ...
  fields: {
    ...
    residenceCountry: "Pays de résidence", billingRecipientType: "Ce compte est pour",
...
const ar: EarlyAccessCopy = {
  ...
  fields: {
    ...
    residenceCountry: "بلد الإقامة", billingRecipientType: "هذا الحساب لـ",
...
const nl: EarlyAccessCopy = {
  ...
  fields: {
    ...
    residenceCountry: "Land van verblijf", billingRecipientType: "Dit account is voor",
...
const es: EarlyAccessCopy = {
  ...
  fields: {
    ...
    residenceCountry: "País de residencia", billingRecipientType: "Esta cuenta es para",
...
const de: EarlyAccessCopy = {
  ...
  fields: {
    ...
    residenceCountry: "Wohnsitzland", billingRecipientType: "Dieses Konto ist für",
...
const pt: EarlyAccessCopy = {
  ...
  fields: {
    ...
    preferredContactMethod: "Método de contacto preferido", preferredLanguage: "Idioma preferido",
    residenceCountry: "País de residência", billingRecipientType: "Esta conta é para",
